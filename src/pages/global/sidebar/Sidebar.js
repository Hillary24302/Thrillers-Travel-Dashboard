    ...
    >
      <Container fluid={true}>
      {
        ...
        <div style={{marginTop: '12px', marginRight: '-10px'}}>
          <SearchBar backgroundColor='#1D2739' color='#F9FAFB' border='#1D2739' placeholder='Search'/>
        </div>
        <div className="k-sidebar-main" style={{marginTop: '15px',  marginRight: '-15px'}}>
          <Menu
            style={{
              width: "100%",
            }}
        ...
        <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'space-around', alignItems: 'center', background: 'transparent' }}>
          {collapsed ? (
            <FancyIcon image={<img src={profileImage} />} verified={true} />
          ) : (
            <>
              <FancyIcon image={<img src={profileImage} />} verified={true} width='46px' height='46px'/>
